...
const PARAMS = [
  {
    name: '*columns',
    description: 'List of column names (string) or expressions (Column). If one of the column names is ‘*’, that column is expanded to include all columns in the current DataFrame.',
    required: true,
  }
];
